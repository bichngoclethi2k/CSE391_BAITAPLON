...
<head>
    ...
    <link rel="stylesheet" href="style.3.3.css">
          ...
          <div class="col-md-3 text-left" style="background: rgba(194, 194, 194,0.4)">
              <ul class="nav nav-tabs flex-column bg-light" role="tablist">
                  ...
                  <li class="nav-item" style="padding-bottom: 500px;">
                      <a class="nav-link active" href="../LienHe/index.3.3.php" data-toggle="tab">Liên hệ</a>
                  </li>
              </ul>
          </div>
          <div class="col-md-9 bg-white">
            <div class="tab-content">
                <div class="container tab-panel active" id="tab4"><br>
                    <h1 class="text-uppercase mb-5" style=" font-weight: bold;">Văn phòng Việt Nam</h1>
                    <h5 class="text-uppercase mb-4">Trụ sở Hà Nội</h5>
                    <ul class="text-left" style="font-size: larger;">
                        <li>Địa chỉ: Tầng 17, HL Tower, 82 Duy Tân, Hà Nội.</li>
                        <li>Điện thoại: (+84) 024 66873572</li>
                        <li>Email: contact@ymeet.me</li>
                    </ul>
                    <h1 class="text-uppercase my-5" style=" font-weight: bold;">Văn phòng Nhật Bản</h1>
                    <h5 class="text-uppercase mb-4">Trụ sở chính Kyoto</h5>
                    <ul class="text-left" style="font-size: larger;">
                        <li>Địa chỉ: Yoshida Izumiden cho, Sakyo, Kyoto City.</li>
                        <li>Điện thoại: +81-75-771-2881</li>
                    </ul>
                    <h5 class="text-uppercase my-4">Chi nhánh Tokyo</h5>
                    <ul class="text-left" style="font-size: larger;">
                        <li>Địa chỉ: Akasaka, Minato, Tokyo, Japan.</li>
                        <li>Điện thoại: +81-3-5474-0838</li>
                    </ul>
                </div>
            </div>
        </div>
